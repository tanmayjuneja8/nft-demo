...
def main():
    ...
    no_of_collectibles = adv_collectible.tokenCounter()
    ...
    for token_id in range(no_of_collectibles):
        ...
        if not adv_collectible.tokenURI(token_id).startswith("https://"):
            print(f"Setting tokenURI of {token_id}")
            set_tokenURI(token_id, adv_collectible, dog_metadata_dic[breed])
